        ...
        <motion.div ref={ref} className="contact" variants={variants} initial="initial" whileInView="animate">
            <motion.div className="textContainer" variants={variants}>
                ...
                <motion.div variants={variants} className="item">
                    <h2>Mail</h2>
                    <span>yuva@vt.edu</span>
                </motion.div>
                <motion.div variants={variants} className="item">
                    <h2>Address</h2>
                    <span>1215 Progress ST NW Apt B Blacksburg VA US</span>
                </motion.div>
                <motion.div variants={variants} className="item">
                    <h2>Phone</h2>
                    <span>+1(301)-550-1020</span>
                </motion.div>
            </motion.div>
            ...
            C32.666,7.326,25.339,0,16.333,0z"
                ...
                <motion.form ref={formRef} onSubmit={sendEmail} initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ delay: 4, duration: 1 }}>
                    ...
                    <textarea placeholder="Type your message" rows="8" name="message" />
